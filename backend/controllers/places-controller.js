...
const createPlace = async (req, res, next) => {
  ...
  console.log("🚀 ~ createPlace ~ creator:", creator)
  console.log("🚀 ~ createPlace ~ address:", address)
  console.log("🚀 ~ createPlace ~ description:", description)
  console.log("🚀 ~ createPlace ~ title:", title)
